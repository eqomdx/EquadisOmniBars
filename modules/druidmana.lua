--[[ Equadis' Classic Overhaul :: druid secondary mana
...
--[[ A position for a number nobody is drawing. Greyed rather than removed: it
     still means what it says the moment Text is set to anything again. ]]--
OB.predicates = OB.predicates or {}

OB.predicates.druid_no_text = function()
    local cfg = OB.profile and OB.profile.modules and OB.profile.modules.druidmana
