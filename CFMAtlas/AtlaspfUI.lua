...
init:SetScript("OnEvent", function()
    if arg1 == "Atlas-CFM" or arg1 == "EquadisClassicOverhaul" then
    ...
    if (this.atlasLoaded or IsAddOnLoaded("Atlas-CFM") or IsAddOnLoaded("EquadisClassicOverhaul")) and (this.pfuiLoaded or IsAddOnLoaded("pfUI")) then
